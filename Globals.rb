...
$cfg.app.font.name = ["Tahoma","Bitstream Vera Sans", "Verdana", "Trebuchet MS", "Tahoma", "Arial"]
$cfg.ri_font = ["Tahoma","Bitstream Vera Sans Mono", "Courier New", "Courier"]
$cfg.app.font.size = 12
